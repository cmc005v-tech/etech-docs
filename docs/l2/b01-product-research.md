...
<Quiz title="L2B-01 选品与市场调研 · 自测" :questions="[
  { q: '创业四阶段路线图中，验证期（0-3 月）的成本纪律是？', options: ['<1 万元，不租门面不招人', '1-5 万元，可小规模招人', '按利润滚动投入', '资源/品牌/技术重点投入'], answer: 0, explain: '验证期用贸易/代销/手动服务验证需求真实，成本<1 万元且不租门面不招人；阶段切换看指标达标，强行跳级等于自杀。' },
