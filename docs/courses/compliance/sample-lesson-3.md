...
<Quiz title="样章自测 · 美国市场合规" :questions="[
  { q: 'UFLPA的“可反驳推定”原则意味着什么？', options: ['卖家无需任何举证即可放行', '涉敏感供应链的货物默认禁入，举证责任在进口方', '只有大品牌才会被审查', '该法规只针对美国本土企业'], answer: 1, explain: '可反驳推定把举证责任倒置给进口方，供应链溯源档案是核心应对。' },
  { q: '美国合规违规的最大成本通常是？', options: ['罚款金额本身', '断货、下架与资金冻结等连锁后果', '补办认证的费用', '律师咨询费'], answer: 1, explain: '执法的连锁反应（断货/下架/冻结）远超罚款本身，这是合规投入的核心理由。' },
  { q: '儿童产品进入美国市场，以下哪项不是CPSIA体系的要求？', options: ['第三方检测', 'CPC儿童产品证书', '追踪标签', '美国本土生产'], answer: 3, explain: 'CPSIA要求检测、证书与追踪标签，不要求本土生产。' },
]" />

::: info 内容说明
本页为第 3 课免费试听样章（精编版）。其余各课完整教案、讲师手册、全部工具模板与随堂小测面向报名学员定向分发，不在本站公开。法规时效性强，授课时以最新官方规则为准。
:::
