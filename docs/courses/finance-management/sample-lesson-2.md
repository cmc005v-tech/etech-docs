...
<Quiz title="样章自测 · 成本结构与利润模型" :questions="[
  { q: 'Temu 全托管 64% 与亚马逊自营 16% 的利润率差异，本质是？', options: ['经营能力差距', '收入口径差距——供货价对零售价', '平台补贴差异', '汇率影响'], correct: 1, explanation: '口径统一四步法：定收入口径→定成本边界→定分摊规则→定对比基准——经营会上只允许出现统一口径后的数字。' },
  { q: '毛利率 30% 的商品，盈亏平衡 ROI 是？', options: ['>2.0', '>3.3', '>4.5', '无法计算'], correct: 1, explanation: '盈亏平衡 ROI = 1÷毛利率 = 1÷30% ≈ 3.3，低于即广告卖一单亏一单；配套基准：LTV/CAC >3、TACOS ≤15%、ACOS ≤25%。' },
  { q: '跨境电商全链路成本占售价与行业净利率的基准是？', options: ['成本 50-60%，净利率 20%+', '成本 90-97%，净利率 3-10%', '成本 70-80%，净利率 10-15%', '成本 30-40%，净利率 30%+'], correct: 1, explanation: '成本占售价 90-97%、净利率仅 3-10%——任何一项成本多 3 个点，利润就少三分之一，这是所有测算的锚点。' }
]" />
