...
<Quiz title="L3-A 第5课 · 自测" :questions="[
  { q: 'AI 报表自动生成能把数据清洗时间从 2 小时压缩到？', options: ['10 分钟', '5 分钟', '30 秒', '1 分钟'], answer: 2, explain: 'AI 报表自动生成把 2 小时数据清洗压缩到 30 秒。但数据需抽样验证准确性，防止数据源错误。' },
  { q: '5 Why 根因分析建议追到第几层？', options: ['1-2 层', '3-5 层', '至少 10 层', '越多越好'], answer: 1, explain: '建议追到 3-5 层 Why。1-2 层太浅只看到表面，3-5 层能找到可行动的根因，10 层以上过度分析浪费时间。' },
  { q: 'AI 预测工具的准确率通常在什么范围？', options: ['50-60%', '70-85%', '95%以上', '100%'], answer: 1, explain: 'AI 预测准确率通常 70-85%，需预留 15-30% 偏差空间。结论必须经过业务逻辑验证才能用于决策。' },
  { q: 'L3-A 第三阶段的核心交付件不包括？', options: ['数据看板', '根因分析报告', '广告投放方案', '优化迭代方案'], answer: 2, explain: '第三阶段交付件：数据看板+根因分析报告+优化迭代方案。广告投放方案是第二阶段的交付件。' }
]" />
